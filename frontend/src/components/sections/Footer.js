  ...
  return (
    <div tw='bg-gray-900'>
      <div tw='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8'>
        <div tw='grid row-gap-10 mb-8 lg:grid-cols-6'>
          <div tw='grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4'>
            <div>
              <p tw='font-medium tracking-wide text-gray-300'>Category</p>
              <ul tw='mt-2 space-y-2'>
                <li>
                  <a
                    href='/'
                    tw='text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200'
                  >
                    News
                  </a>
                </li>
            ...
            <div>
              <p tw='font-medium tracking-wide text-gray-300'>Apples</p>
              <ul tw='mt-2 space-y-2'>
                <li>
                  <a
                    href='/'
            ...
            <div>
              <p tw='font-medium tracking-wide text-gray-300'>Cherry</p>
              <ul tw='mt-2 space-y-2'>
                <li>
                  <a
                    href='/'
            ...
            <div>
              <p tw='font-medium tracking-wide text-gray-300'>Business</p>
              <ul tw='mt-2 space-y-2'>
                <li>
                  <a
                    href='/'
          ...
          <div tw='md:max-w-md lg:col-span-2'>
            <span tw='text-base font-medium tracking-wide text-gray-300'>
        ...
        <div tw='flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row'>
          ...
          <div tw='flex items-center mt-4 space-x-4 sm:mt-0'>
            <a
              href='/'
              tw='text-gray-500 transition-colors duration-300 hover:text-teal-accent-400'
            >
